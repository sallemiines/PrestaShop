...
scenario('Open all menu links in the Back Office', () => {
  ...
  scenario('Check all the menu links of "CONFIGURE"', () => {
    scenario('Check all the menu links of "Shop Parameters" in the Back Office', client => {
      ...
      common.clickOnMenuLinksAndCheckElement(client, Menu.Configure.ShopParameters.shop_parameters_menu, Menu.Configure.ShopParameters.contact_submenu, PagesForm.ShopParameters.stores_form, "Contact", "Store", 0, Menu.Configure.ShopParameters.stores_tab);
