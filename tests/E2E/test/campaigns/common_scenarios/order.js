...
module.exports = {
  ...
  checkCreditSlip: function (refundedValue, i) {
    scenario('Check the credit slip information', client => {
      ...
      test('should check the "Invoice Product Reference" ', () => client.checkDocument(global.downloadsFolderPath, global.creditSlip, global.orderInformation[i].productRef));
      ...
      test('should check the "Tax detail" ', () => client.checkDocument(global.downloadsFolderPath, global.creditSlip, 'Products'));
    }, 'order');
  },
